...
python ../run_nb_flax_speech_recognition_seq2seq_streaming_dev3_oldloss.py \
    ...
    --output_dir ../../deci_64bs_1e06lr_dsp_v7_oldloss\
    ...
    --hub_model_id NbAiLab/deci_64bs_1e06lr_dsp_v7_oldloss \
