...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
        ...
        --run_name "Scream - scream_duodevicesimus_working_exp_adam " \
        ...
        --output_dir ../../../scream_duodevicesimus_working_exp_adam  \
        ...
        --hub_model_id NbAiLab/scream_duodevicesimus_working_exp_adam \
