...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
        ...
        --run_name "Scream - scream_duodevicesimus_exp_weight_decay" \
        ...
        --output_dir ../../../scream_duodevicesimus_exp_weight_decay \
        ...
        --hub_model_id NbAiLab/scream_duodevicesimus_exp_weight_decay  \
