...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    ...
    --run_name "NB-Whisper - small - dynamic eval v0.1c" \
    --run_description "A NB-Whisper dynamic eval v0.1c" \
    ...
    --dataset_load_fn "utils.dataset_load_rc_dynamic.load_dataset_nbwhisper_rc_dynamic" \
    --test_split_name "test_nst,test_clean_stortinget_no" \
    --eval_split_name "validation_nst,validation_clean_stortinget_no" \
    --hub_model_id NbAiLab/nb-whisper-small-v0.1c \
    --output_dir ../../../nb-whisper-small-v0.1c \
