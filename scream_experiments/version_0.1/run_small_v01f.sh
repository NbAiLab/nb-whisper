...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    ...
    --run_name "NB-Whisper - small - dynamic eval semantic v0.1f" \
    --run_description "A NB-Whisper dynamic eval semantic v0.1f" \
    ...
    --hub_model_id NbAiLab/nb-whisper-small-v0.1f \
    --output_dir ../../../nb-whisper-small-v0.1f \
