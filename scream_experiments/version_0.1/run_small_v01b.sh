...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    ...
    --run_name "NB-Whisper - small - dynamic eval v0.1b" \
    --run_description "A NB-Whisper dynamic eval v0.1b" \
    ...
    --hub_model_id NbAiLab/nb-whisper-small-v0.1b \
    --output_dir ../../../nb-whisper-small-v0.1b \
