...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    --model_name_or_path NbAiLab/nb-whisper-large-v2-RC3 \
    --run_name "NB-Whisper - large - dynamic eval v0.8 - vad3" \
    --run_description "A NB-Whisper dynamic eval v0.8 - vad3" \
    ...
    --hub_model_id NbAiLab/nb-whisper-large-v2-v0.8-vad3 \
    --output_dir ../../../nb-whisper-large-v2-v0.8-vad3 \
