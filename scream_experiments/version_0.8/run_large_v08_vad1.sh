...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    ...
    --run_name "NB-Whisper - large - dynamic eval v0.8 - vad1" \
    --run_description "A NB-Whisper dynamic eval v0.8 - vad1" \
    ...
    --hub_model_id NbAiLab/nb-whisper-large-v0.8-vad1 \
    --output_dir ../../../nb-whisper-large-v0.8-vad1 \
