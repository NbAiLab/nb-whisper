...
## RENAMED TO NbAiLabBeta/nb-whisper-large


# Running the Python script
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    --model_name_or_path NbAiLab/nb-whisper-large-v3-RC4 \
    --run_name "NB-Whisper - large - dynamic eval v0.8" \
    --run_description "A NB-Whisper dynamic eval v0.8" \
    ...
    --dataset_load_fn "utils.dataset_load_rc_dynamic_noellipses_turndupwords_nosilence.load_dataset_nbwhisper_rc_dynamic_eval_verbatim" \
    --test_split_name "test_nst,test_clean_stortinget_no" \
    --eval_split_name "validation_nst,validation_clean_stortinget_no" \
    --hub_model_id NbAiLab/nb-whisper-large-v0.8 \
    --output_dir ../../../nb-whisper-large-v0.8 \
