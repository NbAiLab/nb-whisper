...
## RENAMED TO NbAiLabBeta/nb-whisper-medium


# Running the Python script
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    --model_name_or_path NbAiLab/nb-whisper-medium-RC1 \
    --run_name "NB-Whisper - medium - dynamic eval v0.8-vad3" \
    ...
    --hub_model_id NbAiLab/nb-whisper-medium-v0.8-vad3 \
    --output_dir ../../../nb-whisper-medium-v0.8-vad3 \
