...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    ...
    --run_name "NB-Whisper - tiny - singletask verbose_v1" \
    --run_description "A NB-Whisper singletask_verbose_v1" \
    ...
    --hub_model_id NbAiLab/nb-whisper-tiny-singletask_rc_verbose_v1 \
    --output_dir ../../../nb-whisper-tiny-singletask_rc_verbose_v1 \
