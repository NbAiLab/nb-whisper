...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    ...
    --run_name "NB-Whisper - verbose2" \
    --run_description "A small NB-Whisper verbose nst audio" \
    ...
    --dataset_load_fn "utils.dataset_load_rc_verbose_nst_audio.load_dataset_nbwhisper_verbose_nst_audio" \
    --test_split_name "test_norwegian_fleurs" \
    --eval_split_name "validation_norwegian_fleurs" \
    --hub_model_id NbAiLab/nb-whisper-small-style-verbose-nst-audio \
    --output_dir ../../../nb-whisper-small-style-verbose-nst-audio \
