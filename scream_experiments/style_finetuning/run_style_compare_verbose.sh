...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    ...
    --run_name "NB-Whisper - verbose - compare style verbose" \
    --run_description "A small NB-Whisper compare style verbose" \
    ...
    --hub_model_id NbAiLab/nb-whisper-small-style-compare-style-verbose \
    --output_dir ../../../nb-whisper-small-style-compare-style-verbose \
