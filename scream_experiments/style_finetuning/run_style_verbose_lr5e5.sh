...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    ...
    --run_name "NB-Whisper - verbose - lr5e5" \
    --run_description "A small NB-Whisper verbose lr5e5" \
    ...
    --hub_model_id NbAiLab/nb-whisper-small-style-verbose-lr5e5 \
    --output_dir ../../../nb-whisper-small-style-verbose-lr5e5 \
