...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    ...
    --run_description "A small NB-Whisper verbose test" \
    ...
    --hub_model_id NbAiLab/nb-whisper-small-style-verbose-test2 \
    --output_dir ../../../nb-whisper-small-style-verbose-test2 \
