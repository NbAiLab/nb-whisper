...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    ...
    --dataset_load_fn "utils.dataset_load_singletask.load_dataset_nbwhisper_singletask" \
    ...
    --hub_model_id NbAiLab/nb-whisper-tiny-singletask \
    --output_dir ../../../nb-whisper-tiny-singletask \
