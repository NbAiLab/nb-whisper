...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    ...
    --run_name "NB-Whisper - verbose - compare style combined v3" \
    --run_description "A small NB-Whisper compare style combined v3" \
    ...
    --hub_model_id NbAiLab/nb-whisper-small-style-compare-style-combined-v3 \
    --output_dir ../../../nb-whisper-small-style-compare-style-combined-v3 \
