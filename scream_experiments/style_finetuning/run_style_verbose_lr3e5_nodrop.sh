...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    ...
    --run_name "NB-Whisper - verbose - lr3e5-nodrop" \
    --run_description "A small NB-Whisper verbose lr3e5-nodrop" \
    ...
    --hub_model_id NbAiLab/nb-whisper-small-style-verbose-lr3e5-nodrop \
    --output_dir ../../../nb-whisper-small-style-verbose-lr3e5-nodrop \
