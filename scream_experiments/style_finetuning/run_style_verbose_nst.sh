...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    ...
    --run_description "A small NB-Whisper verbose nst" \
    ...
    --dataset_load_fn "utils.dataset_load_rc_verbose_nst.load_dataset_nbwhisper_verbose_nst" \
    --test_split_name "test_norwegian_fleurs" \
    --eval_split_name "validation_norwegian_fleurs" \
    --hub_model_id NbAiLab/nb-whisper-small-style-verbose-nst \
    --output_dir ../../../nb-whisper-small-style-verbose-nst \
