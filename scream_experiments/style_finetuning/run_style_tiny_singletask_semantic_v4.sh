...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    ...
    --run_name "NB-Whisper - tiny - singletask semantic_v4" \
    ...
    --hub_model_id NbAiLab/nb-whisper-tiny-singletask_rc_semantic_v4 \
    --output_dir ../../../nb-whisper-tiny-singletask_rc_semantic_v4 \
