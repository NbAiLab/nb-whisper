...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    ...
    --run_name "NB-Whisper - verbose1" \
    --run_description "A small NB-Whisperverbose test" \
    ...
    --hub_model_id NbAiLab/nb-whisper-small-style-verbose-test1 \
    --output_dir ../../../nb-whisper-small-style-verbose-test1 \
