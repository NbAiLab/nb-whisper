...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_debug.py \
        ...
        --output_dir ../../../scream_tertius_simplemap_labels\
        ...
        --hub_model_id NbAiLab/scream_tertius_simplemap_labels\
        ...
        --log_examples 100 \
        --data_mapping_fn "utils.data_mapping_scream_labels.map_data" \
        --push_to_hub
