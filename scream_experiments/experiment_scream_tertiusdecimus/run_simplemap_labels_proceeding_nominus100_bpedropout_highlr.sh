...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_debug2.py \
        ...
        --run_name "Scream - tertius_simplemap_labels_proceeding_nominus100_bpedropout_highlr" \
        --run_description "A Small Scream model. " \
        ...
        --output_dir ../../../scream_tertius_simplemap_labels_proceeding_nominus100_bpedropout_highlr\
        ...
        --hub_model_id NbAiLab/scream_tertius_simplemap_labels_proceeding_nominus100_bpedropout_highlr\
