...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_debug2.py \
        ...
        --run_name "Scream - tertius_simplemap_labels encoder dropout" \
        ...
        --output_dir ../../../scream_tertius_simplemap_labels_proceeding_nominus100_encoderdropout\
        ...
        --hub_model_id NbAiLab/scream_tertius_simplemap_labels_proceeding_nominus100_encoderdropout\
