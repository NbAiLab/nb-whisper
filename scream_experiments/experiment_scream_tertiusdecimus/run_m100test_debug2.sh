...
# Alse exists as NbAiLab/scream_tertius_simplemap_labels_proceeding_nominus100_bpedropout_activation_highlr
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_debug2.py \
        --model_name_or_path openai/whisper-small \
        --run_name "Scream - m100test_debug2" \
        ...
        --output_dir ../../../scream_m100test_debug2\
        ...
        --hub_model_id NbAiLab/scream_m100test_debug2\
