...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
        ...
        --output_dir ../../../scream_tertius_simplemap_labels_proceeding_allminus100_bpedropout_activation_highlr\
        ...
        --hub_model_id NbAiLab/scream_tertius_simplemap_labels_proceeding_allminus100_bpedropout_activation_highlr\
