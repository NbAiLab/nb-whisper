...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
        ...
        --run_name "Scream - tertius_dropout_replicate_test7a" \
        ...
        --output_dir ../../../scream_tertius_dropout_replicate_test7a\
        ...
        --hub_model_id NbAiLab/scream_tertius_dropout_replicate_test7a \
