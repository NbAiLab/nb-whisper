...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_debug.py \
        ...
        --run_name "Scream - tertius_dropout_replicate_test7b" \
        ...
        --output_dir ../../../scream_tertius_dropout_replicate_test7b\
        ...
        --hub_model_id NbAiLab/scream_tertius_dropout_replicate_test7b\
