...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_debug.py \
        ...
        --run_name "Scream - tertius_dropout_replicate_test7c_nodropout_nomask" \
        --run_description "A Small Scream model. Duodecimus. No dropout no mask" \
        ...
        --output_dir ../../../scream_tertius_dropout_replicate_test7c_nodropout_nomask\
        ...
        --hub_model_id NbAiLab/scream_tertius_dropout_replicate_test7c_nodropout_nomask\
