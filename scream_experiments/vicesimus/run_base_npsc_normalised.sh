...
export TCMALLOC_base_ALLOC_REPORT_THRESHOLD=10000000000

# Running the Python script
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    --model_name_or_path NbAiLab/nb-whisper-base-beta \
    ...
    --hub_model_id NbAiLab/nb-whisper-base-publicbeta-npsc-normalised \
    --output_dir ../../../nb-whisper-base-publicbeta-npsc-normalised \
