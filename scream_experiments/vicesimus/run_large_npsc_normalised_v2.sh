...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    --model_name_or_path NbAiLab/nb-whisper-large-publicbeta-30k \
    --run_name "Scream - medium_npsc_norm_v2 200" \
    ...
    --hub_model_id NbAiLab/nb-whisper-large-publicbeta-npsc-normalised_v2 \
    --output_dir ../../../nb-whisper-large-publicbeta-npsc-normalised_v2 \
