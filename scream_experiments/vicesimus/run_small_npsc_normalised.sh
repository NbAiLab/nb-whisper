...
export TCMALLOC_small_ALLOC_REPORT_THRESHOLD=10000000000

# Running the Python script
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    --model_name_or_path NbAiLab/nb-whisper-small-beta \
    ...
    --hub_model_id NbAiLab/nb-whisper-small-publicbeta-npsc-normalised \
    --output_dir ../../../nb-whisper-small-publicbeta-npsc-normalised \
