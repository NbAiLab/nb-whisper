...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    ...
    --run_name "NB-Whisper - large memtest" \
    --run_description "A large NB-Whisper memtest2" \
    ...
    --hub_model_id NbAiLab/nb-whisper-large-memtest2 \
    --output_dir ../../../nb-whisper-large-memtest2 \
