...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    --model_name_or_path NbAiLab/whisper-large-v3 \
    --run_name "NB-Whisper - large v3 RC3" \
    --run_description "A large NB-Whisper v3 RC4" \
    --wandb_entity "nbailab" \
    --wandb_project "NB-Whisper RC3" \
    ...
    --hub_model_id NbAiLab/nb-whisper-large-v3-RC4 \
    --output_dir ../../../nb-whisper-large-v3-RC4 \
