...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    ...
    --run_name "NB-Whisper - large v2b RC1" \
    --run_description "A large NB-Whisper v2b RC1" \
    ...
    --hub_model_id NbAiLab/nb-whisper-large-v2b-RC1 \
    --output_dir ../../../nb-whisper-large-v2b-RC1 \
