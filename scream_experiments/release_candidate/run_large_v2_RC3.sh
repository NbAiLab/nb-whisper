...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    ...
    --run_name "NB-Whisper - large v2 RC3" \
    --run_description "A large NB-Whisper v2 RC3" \
    ...
    --hub_model_id NbAiLab/nb-whisper-large-v2-RC3 \
    --output_dir ../../../nb-whisper-large-v2-RC3 \
