...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    ...
    --run_name "NB-Whisper - large memtest v3" \
    --run_description "A large NB-Whisper memtest v3" \
    ...
    --hub_model_id NbAiLab/nb-whisper-large-v3-memtest \
    --output_dir ../../../nb-whisper-large-v3-memtest \
