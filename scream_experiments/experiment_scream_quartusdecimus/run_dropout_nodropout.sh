...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
        ...
        --run_description "A Small Scream model. quartusdecimus. Dropout test - no dropout" \
        ...
        --output_dir ../../../scream_quartus_dropout_nodropout\
        ...
        --hub_model_id NbAiLab/scream_quartus_dropout_nodropout \
