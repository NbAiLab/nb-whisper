...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
        ...
        --run_name "Scream - scream_sextusdecimus_virtual_tsfix_tiny" \
        ...
        --output_dir ../../../scream_sextusdecimus_virtual_tsfix_tiny\
        ...
        --hub_model_id NbAiLab/scream_sextusdecimus_virtual_tsfix_tiny\
