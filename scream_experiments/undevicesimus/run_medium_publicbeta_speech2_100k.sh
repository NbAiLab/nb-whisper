...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    ...
    --run_name "Scream - medium_public_beta 100k" \
    ...
    --hub_model_id NbAiLab/nb-whisper-medium-publicbeta-speech2-100k \
    --output_dir ../../../nb-whisper-medium-publicbeta-speech2-100k \
