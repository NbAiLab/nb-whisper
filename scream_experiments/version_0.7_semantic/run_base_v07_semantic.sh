...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    --model_name_or_path NbAiLabBeta/nb-whisper-base \
    --run_name "NB-Whisper - base - dynamic semantic v0.7" \
    ...
    --hub_model_id NbAiLab/nb-whisper-base-v0.7-semantic \
    --output_dir ../../../nb-whisper-base-v0.7-semantic \
