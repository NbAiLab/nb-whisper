...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
        ...
        --output_dir ../../../scream_duo_dropout_dropout_prompt_test2\
        ...
        --hub_model_id NbAiLab/scream_duo_dropout_dropout_prompt_test2 \
        ...
        --log_examples 100 \
        --data_mapping_fn "data_mapping_scream_test2.map_data" \
        --dropout 0.1 \
        --push_to_hub
