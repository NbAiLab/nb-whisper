...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
        ...
        --run_description "A Small Scream model. Duodecimus. Dropout test - attention dropout" \
        ...
        --output_dir ../../scream_duo_dropout_attention_dropout\
        ...
        --hub_model_id NbAiLab/scream_duo_dropout_attention_dropout \
