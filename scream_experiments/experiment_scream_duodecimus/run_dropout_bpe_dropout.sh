...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
        ...
        --run_description "A Small Scream model. Duodecimus. Dropout test - bpe dropout" \
        ...
        --output_dir ../../../scream_duo_dropout_bpe_nodropout\
        ...
        --hub_model_id NbAiLab/scream_duo_dropout_bpe_dropout \
