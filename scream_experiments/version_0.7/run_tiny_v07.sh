...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    ...
    --run_name "NB-Whisper - tiny - dynamic eval v0.7" \
    --run_description "A NB-Whisper tiny dynamic eval v0.7" \
    ...
    --hub_model_id NbAiLab/nb-whisper-tiny-v0.7 \
    --output_dir ../../../nb-whisper-tiny-v0.7 \
