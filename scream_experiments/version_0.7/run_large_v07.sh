...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    --model_name_or_path NbAiLab/nb-whisper-large-RC4 \
    --run_name "NB-Whisper - large - dynamic eval v0.7" \
    --run_description "A NB-Whisper dynamic eval v0.7" \
    ...
    --hub_model_id NbAiLab/nb-whisper-large-v0.7 \
    --output_dir ../../../nb-whisper-large-v0.7 \
