...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    ...
    --hub_model_id NbAiLab/nb-whisper-large-publicbeta-speech2-noact-eval8-train22-100k \
    --output_dir ../../../nb-whisper-large-publicbeta-speech2-noact-eval8-train22-100k \
