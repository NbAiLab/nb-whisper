...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    ...
    --run_name "NB-Whisper - tiny - dynamic RC1" \
    --run_description "A NB-Whisper dynamic RC1" \
    ...
    --hub_model_id NbAiLab/nb-whisper-tiny-dynamic-RC1 \
    --output_dir ../../../nb-whisper-tiny-dynamic-RC1 \
