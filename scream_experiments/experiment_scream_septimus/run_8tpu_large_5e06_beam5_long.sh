...
python ../run_flax_speech_recognition_seq2seq_streaming.py \
    ...
    --run_name "Scream - sep_8tpu_large_5e06_beam5_long" \
    ...
    --output_dir ../../scream_sep_8tpu_large_5e06_beam5_long\
    ...
    --hub_model_id NbAiLab/scream_sep_8tpu_large_5e06_beam5_long \
