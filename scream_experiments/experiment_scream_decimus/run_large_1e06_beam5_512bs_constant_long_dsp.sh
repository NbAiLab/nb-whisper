...
python ../run_nb_flax_speech_recognition_seq2seq_streaming_dsp.py \
    ...
    --run_name "Scream - deci_512bs_1e06lr" \
    --run_description "A Large Whisper Scream model - Dynamic Style Prompting." \
    ...
    --output_dir ../../deci_512bs_1e06lr_dsp\
    ...
    --hub_model_id NbAiLab/deci_512bs_1e06lr_dsp \
