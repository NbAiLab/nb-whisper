...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    ...
    --run_name "NB-Whisper - medium - dynamic eval v0.4e" \
    --run_description "A NB-Whisper dynamic eval v0.4e" \
    ...
    --hub_model_id NbAiLab/nb-whisper-medium-v0.4e \
    --output_dir ../../../nb-whisper-medium-v0.4e \
