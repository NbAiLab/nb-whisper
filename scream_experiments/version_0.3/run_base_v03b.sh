...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    ...
    --run_name "NB-Whisper - base - dynamic eval v0.3b" \
    --run_description "A NB-Whisper base dynamic eval v0.3b" \
    ...
    --hub_model_id NbAiLab/nb-whisper-base-v0.3b \
    --output_dir ../../../nb-whisper-base-v0.3b \
