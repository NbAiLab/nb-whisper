...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    ...
    --run_name "NB-Whisper - medium - dynamic eval v0.3d" \
    --run_description "A NB-Whisper dynamic eval v0.3d" \
    ...
    --dataset_load_fn "utils.dataset_load_rc_dynamic_nstandaudio.load_dataset_nbwhisper_rc_dynamic_eval_verbatim" \
    --test_split_name "test_nst,test_clean_stortinget_no" \
    --eval_split_name "validation_nst,validation_clean_stortinget_no" \
    --hub_model_id NbAiLab/nb-whisper-medium-v0.3d \
    --output_dir ../../../nb-whisper-medium-v0.3d \
