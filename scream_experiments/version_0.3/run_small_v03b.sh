...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    ...
    --run_name "NB-Whisper - emall - dynamic eval v0.3b" \
    --run_description "A NB-Whisper dynamic small eval v0.3b" \
    ...
    --hub_model_id NbAiLab/nb-whisper-small-v0.3b \
    --output_dir ../../../nb-whisper-small-v0.3b \
