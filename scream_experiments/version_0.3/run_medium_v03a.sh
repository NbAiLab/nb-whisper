...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    ...
    --run_name "NB-Whisper - medium - dynamic eval v0.3a" \
    --run_description "A NB-Whisper dynamic eval v0.3a" \
    ...
    --hub_model_id NbAiLab/nb-whisper-medium-v0.3a \
    --output_dir ../../../nb-whisper-medium-v0.3a \
