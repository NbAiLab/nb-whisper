...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    --model_name_or_path NbAiLab/nb-whisper-large-publicbeta-20bpe-30k \
    --run_name "Scream - large-fine4a-npsc-norm-nohes-30k" \
    ...
    --hub_model_id NbAiLab/nb-whisper-large-fine4a-npsc-norm-nohes-30k \
    --output_dir ../../../nb-whisper-large-fine4a-npsc-norm-nohes-30k \
