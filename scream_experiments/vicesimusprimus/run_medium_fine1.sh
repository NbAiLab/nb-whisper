...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    ...
    --dataset_load_fn "utils.dataset_load_npsc.load_dataset_npsc_raw" \
    --test_split_name "test" \
    --eval_split_name "validation" \
    --hub_model_id NbAiLab/nb-whisper-medium-fine1-npsc-raw \
    --output_dir ../../../nb-whisper-medium-fine1-npsc-raw \
