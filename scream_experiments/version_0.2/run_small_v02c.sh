...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    ...
    --run_name "NB-Whisper - small - dynamic eval semantic v0.2c" \
    --run_description "A NB-Whisper dynamic eval semantic v0.2c" \
    ...
    --hub_model_id NbAiLab/nb-whisper-small-v0.2c \
    --output_dir ../../../nb-whisper-small-v0.2c \
