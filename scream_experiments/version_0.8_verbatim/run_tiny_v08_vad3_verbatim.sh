...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    --model_name_or_path NbAiLab/nb-whisper-tiny-v0.8-vad3 \
    --run_name "Scream - tiny-v0.8-vad3-verbatim-npsc" \
    ...
    --hub_model_id NbAiLab/nb-whisper-tiny-v0.8-vad3-verbatim \
    --output_dir ../../../nb-whisper-tiny-v0.8-vad3-verbatim \
