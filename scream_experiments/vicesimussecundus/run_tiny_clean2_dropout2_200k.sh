...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    ...
    --run_name "NB-Whisper - tiny dropout2 200k" \
    --run_description "A TIny NB-Whisper Dropout2 200k" \
    ...
    --hub_model_id NbAiLab/nb-whisper-tiny-dropout2-200k \
    --output_dir ../../../nb-whisper-tiny-dropout2-200k \
