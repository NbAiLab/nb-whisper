...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    ...
    --run_name "NB-Whisper - small unclean 25k" \
    --run_description "A Small NB-Whisper Unlean" \
    --wandb_entity "nbailab" \
    --wandb_project "NB-Whisper Public Beta" \
    --dataset_name NbAiLab/ncc_speech_v6_unclean \
    --language Norwegian \
    ...
    --hub_model_id NbAiLab/nb-whisper-small-unclean-25k \
    --output_dir ../../../nb-whisper-small-unclean-25k \
