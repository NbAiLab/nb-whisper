...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    ...
    --run_name "NB-Whisper - small clean rerun 25k" \
    --run_description "A Small NB-Whisper Clean rerun" \
    ...
    --hub_model_id NbAiLab/nb-whisper-small-clean-rerun-25k \
    --output_dir ../../../nb-whisper-small-clean-rerun-25k \
