...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    ...
    --run_description "A Small NB-Whisper Clean Extra Dropout" \
    ...
    --hub_model_id NbAiLab/nb-whisper-small-clean2-dropout-25k \
    --output_dir ../../../nb-whisper-small-clean2-dropout-25k \
