...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    ...
    --run_name "NB-Whisper - small clean2 extra dropout 25k" \
    --run_description "A Small NB-Whisper Clean No Dropout" \
    ...
    --hub_model_id NbAiLab/nb-whisper-small-clean2-nodropout-25k \
    --output_dir ../../../nb-whisper-small-clean2-nodropout-25k \
