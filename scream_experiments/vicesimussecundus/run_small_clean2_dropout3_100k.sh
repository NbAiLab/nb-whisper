...
python ../../run_nb_flax_speech_recognition_seq2seq_streaming_dev.py \
    ...
    --run_name "NB-Whisper - small clean2 extra dropout3 100k" \
    --run_description "A Small NB-Whisper Clean Extra Dropout3" \
    ...
    --hub_model_id NbAiLab/nb-whisper-small-clean2-dropout3-100k \
    --output_dir ../../../nb-whisper-small-clean2-dropout3-100k \
