...
python ../run_nb_flax_speech_recognition_seq2seq_streaming_run1.py \
        ...
        --output_dir ../../scream_prompt_test_v4_run1_pere11\
        ...
        --hub_model_id NbAiLab/scream_prompt_test_v4_run1_pere11 \
